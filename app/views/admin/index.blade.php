                        ...
                        <tbody>
                            @foreach( $entries as $entry)
                                <tr class="{{ $colors[$entry->typechange] }}">
                                    ...
                                    @endif
                                    <td class="center">{{ link_to("/registry/edit/{$entry->id}", "Edit") }}</td>
                                    <td class="center">{{ link_to("/registry/delete/{$entry->psapid}", "Delete") }}</td>
                                </tr>
                            @endforeach
